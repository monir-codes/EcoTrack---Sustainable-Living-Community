...
//           {benefits.map((item, i) => (
//             <div key={i} className="group p-8 rounded-[2.5rem] bg-[#1d2327] border border-white/5 hover:border-green-500/30 transition-all duration-500">
...
//         {/* --- Part 2: How It Works --- */}
//         <div className="bg-[#1d2327]/50 border border-white/5 rounded-[3rem] p-10 md:p-16">
...
//             <div className="hidden md:block absolute top-10 left-0 w-full h-0.5 bg-dashed bg-gradient-to-r from-transparent via-green-500/20 to-transparent"></div>

//             {steps.map((step, i) => (
//               <div key={i} className="relative flex flex-col items-center text-center group">
//                 {/* Step Number & Icon */}
//                 <div className="w-20 h-20 rounded-full bg-[#121619] border-4 border-[#1d2327] flex items-center justify-center mb-6 z-10 group-hover:border-green-500 transition-all duration-300 shadow-2xl">
...
//                 {/* Step Content */}
//                 <span className="text-green-500 font-black text-xs uppercase tracking-tighter mb-2">Step 0{i+1}</span>

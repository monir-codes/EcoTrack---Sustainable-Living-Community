...
const RegisterPage = () => {
  ...
  const { signInWithGoogle, setUser, createUser } = useContext(AuthContext); // createUser অ্যাড করা হয়েছে
  ...
  const handleRegister = async (e) => {
    ...
    setIsLoading(true);
    try {
      // Firebase বা Backend এর createUser ফাংশন কল
        ...
        <form className="mt-8 space-y-5" onSubmit={handleRegister}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative group">
              ...
              <input
                type="text"
                required
                className="w-full pl-11 pr-4 py-4 bg-black/20 border border-white/5 rounded-2xl text-white focus:border-green-500/50 transition-all font-medium"
          ...
          <div className="relative group">
            ...
            <input
              type="password"
              required
              className={`w-full pl-11 pr-4 py-4 bg-black/20 border rounded-2xl text-white transition-all font-medium ${
          ...
          {/* Real-time Password Validator Layout */}
          {formData.password && (
            <div className="bg-black/40 p-5 rounded-3xl border border-white/5 grid grid-cols-1 sm:grid-cols-2 gap-3 shadow-inner">
